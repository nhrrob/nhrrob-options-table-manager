<?php
/**
 * Generic DataTables-backed manager for a simple custom table.
 *
...
/**
 * Class CommonTableManager
 *
 * Generic DataTables-backed manager for a simple custom table: server-side
 * search/sort/pagination shared by any table addressed only by column list.
 */
class CommonTableManager extends BaseTableManager {


	/**
	 * Columns eligible for the DataTables global search and sort.
	 *
	 * @var array
	 */
	...
	/**
	 * Bind this manager to a specific table and its searchable columns.
	 *
	 * @param string $table_name Fully-qualified table name.
	 * @param array  $columns    Searchable/sortable column names, in DataTables column order.
	 */
	...
	/**
	 * Edit an option. Not supported for this generic manager.
	 *
	...
	/**
	 * Delete an option. Not supported for this generic manager.
	 *
	 * @return bool Success status
	 */
