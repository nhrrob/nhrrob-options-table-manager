...
class BackupManager {
	...
	/**
	 * Resolve the backups table name.
	 */
	...
	public function get_snapshots() {
        ...
        // phpcs:disable WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- $this->table_name is never user input
	...
	public function restore_snapshot( $id ) {
        ...
        // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching,WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- $this->table_name is never user input
