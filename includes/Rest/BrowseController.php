<?php
/**
 * REST controller for the unified Browse data grid endpoints.
 *
...
class BrowseController extends RestController {
	...
	/**
	 * Read/delete service backing every Browse route.
	 *
	 * @var BrowseService
	 */
	private $browse;
	...
	/**
	 * Wire up the service backing the browse endpoints.
	 *
	 * @param BrowseService $browse Read/delete service for the Browse data grid.
	 */
	...
	/**
	 * Register the Browse REST routes under nhrotm/v1.
	 *
	 * @return void
	 */
		...
		register_rest_route(
			...
			[
				...
				'args'                => [
					...
					'orderby'  => [
						'type'    => 'string',
						'enum'    => [ 'name', 'size', 'autoload', 'id', 'owner' ],
						'default' => 'size',
					],
					'order'    => [
						'type'    => 'string',
					...
					'status'   => [
						'type'    => 'string',
						'enum'    => [ '', 'active', 'expired', 'persistent' ],
						'default' => '',
					],
					'owner'    => [
						'type'              => 'string',
	...
	/**
	 * Delete several records of one type in a single call.
	 *
	...
	/**
	 * Return one filtered, sorted page of records for the requested type.
	 *
	 * @param \WP_REST_Request $request Full REST request.
	 * @return \WP_REST_Response
	 */
	...
	/**
	 * Delete a single record, refusing protected keys.
	 *
	 * @param \WP_REST_Request $request Full REST request.
	 * @return \WP_REST_Response|\WP_Error
	 */
